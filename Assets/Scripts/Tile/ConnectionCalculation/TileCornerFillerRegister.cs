...
public class TileCornerFillerRegister
{
    ...
    public static void TryPlaceCornerFillers(Tile tile)
    {
        ...
        {
            var rightConnectionScore = tile.Neighbours[Direction.Right]?.TryGetTileGround()?.ConnectionScore;
            if (rightConnectionScore == null)
            {
                TryRemoveCornerFiller(tile.Neighbours[Direction.Right], TileCorner.LeftUp);
                TryRemoveCornerFiller(tile.Neighbours[Direction.Right], TileCorner.LeftDown);
            }
            ...
            var downConnectionScore = tile.Neighbours[Direction.Down]?.TryGetTileGround()?.ConnectionScore;
            if (downConnectionScore == null)
            {
                TryRemoveCornerFiller(tile.Neighbours[Direction.Down], TileCorner.LeftUp);
                TryRemoveCornerFiller(tile.Neighbours[Direction.Down], TileCorner.RightUp);
            }
            ...
            var leftConnectionScore = tile.Neighbours[Direction.Left]?.TryGetTileGround()?.ConnectionScore;
            if (leftConnectionScore == null)
            {
                TryRemoveCornerFiller(tile.Neighbours[Direction.Left], TileCorner.RightDown);
                TryRemoveCornerFiller(tile.Neighbours[Direction.Left], TileCorner.RightUp);
            }
            ...
            {
                TryRemoveCornerFiller(tile.Neighbours[Direction.Left], TileCorner.RightUp);
                TryRemoveCornerFiller(tile.Neighbours[Direction.Left], TileCorner.LeftDown);
            }
            ...
            var upConnectionScore = tile.Neighbours[Direction.Up]?.TryGetTileGround()?.ConnectionScore;
            if (upConnectionScore == null)
            {
                TryRemoveCornerFiller(tile.Neighbours[Direction.Up], TileCorner.LeftDown);
                TryRemoveCornerFiller(tile.Neighbours[Direction.Up], TileCorner.RightDown);
            }
        ...
        if (existingGround.ConnectionScore == 17)
        {
            ...
            {
                TryAddCornerFiller(tile.Neighbours[Direction.Right], TileCorner.LeftUp);
                TryAddCornerFiller(tile.Neighbours[Direction.Right], TileCorner.LeftDown);
            }
        ...
        else if (existingGround.ConnectionScore == 18)
        {
            ...
            {
                TryAddCornerFiller(tile.Neighbours[Direction.Down], TileCorner.LeftUp);
                TryAddCornerFiller(tile.Neighbours[Direction.Down], TileCorner.RightUp);
            }
        ...
        else if (existingGround.ConnectionScore == 19)
        {
            ...
            {
                TryAddCornerFiller(tile.Neighbours[Direction.Left], TileCorner.RightDown);
                TryAddCornerFiller(tile.Neighbours[Direction.Left], TileCorner.RightUp);
            }
        ...
        else if (existingGround.ConnectionScore == 20)
        {
            ...
            {
                TryAddCornerFiller(tile.Neighbours[Direction.Up], TileCorner.LeftDown);
                TryAddCornerFiller(tile.Neighbours[Direction.Up], TileCorner.RightDown);
            }
            ...
            {
                TryAddCornerFiller(tile, TileCorner.LeftUp);
                TryAddCornerFiller(tile.Neighbours[Direction.Up], TileCorner.RightUp);
            }
        ...
        else if (existingGround.ConnectionScore == 24)
        {
            ...
            {
                TryRemoveCornerFiller(tile.Neighbours[Direction.Up], TileCorner.LeftUp);
                TryRemoveCornerFiller(tile.Neighbours[Direction.Up], TileCorner.RightUp);
            }
            else if (upConnectionScore == 21)
            {
                TryRemoveCornerFiller(tile, TileCorner.RightUp);
        ...
        else if (existingGround.ConnectionScore == 26)
        {
            ...
            var uppConnectionScore = tile.Neighbours[Direction.Up]?.TryGetTileGround()?.ConnectionScore;
        ...
        else if (existingGround.ConnectionScore == 33)
        {
            ...
            {
                TryAddCornerFiller(tile.Neighbours[Direction.Right], TileCorner.LeftDown);
                TryRemoveCornerFiller(tile.Neighbours[Direction.Right], TileCorner.RightUp);
            }
