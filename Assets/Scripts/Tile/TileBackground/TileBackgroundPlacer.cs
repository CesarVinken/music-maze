...
public abstract class TileBackgroundPlacer<T> where T : Tile
{
    ...
    public void PlacePathVariation(TilePath mazeTilePath)
    {
        ...
        List<TilePath> updatedPathConnections = NeighbourTileCalculator.GetUpdatedTileModifiersForVariation<TilePath>(Tile, mazeTilePath, mazeTilePath.TilePathType.ToString());
